...
def main_test():
    while True:
        ...
        print("camera frame shape: ", type(camera_frames[0][0][0][0])) #(32,32,3)
        print(len(audio_frames))
        print("audio frame shape:", type(audio_frames[0][0][0][0])) #(1,44,13)
...
if __name__=="__main__":
    ...
    '''
    #
    https://research.google.com/audioset/eval/animal.html
    '''
